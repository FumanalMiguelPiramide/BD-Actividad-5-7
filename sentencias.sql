...
USE DATABASE Gimnasio_San_Antonio;
...
nombre varchar (50),
dniEntrenador varchar (9) NOT NULL,
CONSTRAINT pk_Gimnasio PRIMARY KEY (nombre),
CONSTRAINT fk_Gimnasio_Entrenador FOREIGN KEY (dniEntrenador) REFERENCES Entrenador (id)
);
...
CONSTRAINT fk_Cliente_Entrenador_Planificacion_Cliente FOREIGN KEY (dniCliente) REFERENCES Cliente (id),
CONSTRAINT fk_Cliente_Entrenador_Planificacion_Entrenador FOREIGN KEY (dniEntrenador) REFERENCES Entrenador (id),
